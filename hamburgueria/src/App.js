...
function App() {
  const [products, setProducts] = useState([
    { id: 1, name: 'Hamburguer', category: 'Sanduíches', price: 14.00},
    { id: 2, name: 'X-Burguer', category: 'Sanduíches', price: 16.00 },
    { id: 3, name: 'Big Kenzie', category: 'Sanduíches', price: 18.00 },
    { id: 4, name: 'Fanta Guaraná', category: 'Bebidas', price: 5.00},
